...
case controllers_Teams_index0(params) => {
   call { 
        invokeHandler(controllers.Teams.index(), HandlerDef(this, "controllers.Teams", "index", Nil,"GET", """ Default path will just redirect to the list""", Routes.prefix + """"""))
   }
}
