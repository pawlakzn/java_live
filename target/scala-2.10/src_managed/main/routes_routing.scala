...
// @LINE:7
private[this] lazy val controllers_Matches_index1 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("matches/index"))))
        

// @LINE:8
private[this] lazy val controllers_Referees_index2 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("referees/index"))))
        

// @LINE:9
private[this] lazy val controllers_Players_index3 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("players/index"))))
        

// @LINE:10
private[this] lazy val controllers_Seasons_index4 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("seasons/index"))))
        

// @LINE:11
private[this] lazy val controllers_Games_index5 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("games/index"))))
        

// @LINE:12
private[this] lazy val controllers_Users_index6 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("users/index"))))
        

// @LINE:13
private[this] lazy val controllers_Teams_index7 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("teams/index"))))
...
// @LINE:30
private[this] lazy val controllers_Matches_create18 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("matches/new"))))
        

// @LINE:31
private[this] lazy val controllers_Matches_save19 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("matches"))))
        

// @LINE:33
private[this] lazy val controllers_Teams_create20 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("teams/new"))))
        

// @LINE:34
private[this] lazy val controllers_Teams_save21 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("teams"))))
        

// @LINE:36
private[this] lazy val controllers_Referees_create22 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("referees/new"))))
        

// @LINE:37
private[this] lazy val controllers_Referees_save23 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("referees"))))
        

// @LINE:39
private[this] lazy val controllers_Players_create24 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("players/new"))))
        

// @LINE:40
private[this] lazy val controllers_Players_save25 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("players"))))
        

// @LINE:42
private[this] lazy val controllers_Seasons_create26 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("seasons/new"))))
        

// @LINE:43
private[this] lazy val controllers_Seasons_save27 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("seasons"))))
        

// @LINE:45
private[this] lazy val controllers_Games_create28 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("games/new"))))
        

// @LINE:46
private[this] lazy val controllers_Games_save29 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("games"))))
        

// @LINE:48
private[this] lazy val controllers_Users_create30 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("users/new"))))
        

// @LINE:49
private[this] lazy val controllers_Users_save31 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("users"))))
        

// @LINE:52
private[this] lazy val controllers_Matches_edit32 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("matches/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:53
private[this] lazy val controllers_Matches_update33 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("matches/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:55
private[this] lazy val controllers_Teams_edit34 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("teams/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:56
private[this] lazy val controllers_Teams_update35 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("teams/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:58
private[this] lazy val controllers_Referees_edit36 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("referees/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:59
private[this] lazy val controllers_Referees_update37 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("referees/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:61
private[this] lazy val controllers_Players_edit38 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("players/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:62
private[this] lazy val controllers_Players_update39 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("players/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:64
private[this] lazy val controllers_Seasons_edit40 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("seasons/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:65
private[this] lazy val controllers_Seasons_update41 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("seasons/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:67
private[this] lazy val controllers_Games_edit42 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("games/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:68
private[this] lazy val controllers_Games_update43 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("games/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:70
private[this] lazy val controllers_Users_edit44 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("users/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:71
private[this] lazy val controllers_Users_update45 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("users/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:74
private[this] lazy val controllers_Matches_delete46 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("matches/"),DynamicPart("id", """[^/]+""",true),StaticPart("/delete"))))
        

// @LINE:75
private[this] lazy val controllers_Teams_delete47 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("teams/"),DynamicPart("id", """[^/]+""",true),StaticPart("/delete"))))
        

// @LINE:76
private[this] lazy val controllers_Referees_delete48 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("referees/"),DynamicPart("id", """[^/]+""",true),StaticPart("/delete"))))
        

// @LINE:77
private[this] lazy val controllers_Players_delete49 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("players/"),DynamicPart("id", """[^/]+""",true),StaticPart("/delete"))))
        

// @LINE:78
private[this] lazy val controllers_Seasons_delete50 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("seasons/"),DynamicPart("id", """[^/]+""",true),StaticPart("/delete"))))
        

// @LINE:79
private[this] lazy val controllers_Games_delete51 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("games/"),DynamicPart("id", """[^/]+""",true),StaticPart("/delete"))))
        

// @LINE:80
private[this] lazy val controllers_Users_delete52 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("users/"),DynamicPart("id", """[^/]+""",true),StaticPart("/delete"))))
...
// @LINE:7
case controllers_Matches_index1(params) => {
   call { 
        invokeHandler(controllers.Matches.index(), HandlerDef(this, "controllers.Matches", "index", Nil,"GET", """""", Routes.prefix + """matches/index"""))
   }
}
        

// @LINE:8
case controllers_Referees_index2(params) => {
   call { 
...
// @LINE:9
case controllers_Players_index3(params) => {
   call { 
...
// @LINE:10
case controllers_Seasons_index4(params) => {
   call { 
...
// @LINE:11
case controllers_Games_index5(params) => {
   call { 
...
// @LINE:12
case controllers_Users_index6(params) => {
   call { 
...
// @LINE:13
case controllers_Teams_index7(params) => {
   call { 
...
// @LINE:30
case controllers_Matches_create18(params) => {
   call { 
...
// @LINE:31
case controllers_Matches_save19(params) => {
   call { 
...
// @LINE:33
case controllers_Teams_create20(params) => {
   call { 
...
// @LINE:34
case controllers_Teams_save21(params) => {
   call { 
...
// @LINE:36
case controllers_Referees_create22(params) => {
   call { 
...
// @LINE:37
case controllers_Referees_save23(params) => {
   call { 
...
// @LINE:39
case controllers_Players_create24(params) => {
   call { 
...
// @LINE:40
case controllers_Players_save25(params) => {
   call { 
...
// @LINE:42
case controllers_Seasons_create26(params) => {
   call { 
...
// @LINE:43
case controllers_Seasons_save27(params) => {
   call { 
...
// @LINE:45
case controllers_Games_create28(params) => {
   call { 
...
// @LINE:46
case controllers_Games_save29(params) => {
   call { 
...
// @LINE:48
case controllers_Users_create30(params) => {
   call { 
...
// @LINE:49
case controllers_Users_save31(params) => {
   call { 
...
// @LINE:52
case controllers_Matches_edit32(params) => {
...
// @LINE:53
case controllers_Matches_update33(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:55
case controllers_Teams_edit34(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:56
case controllers_Teams_update35(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:58
case controllers_Referees_edit36(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:59
case controllers_Referees_update37(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:61
case controllers_Players_edit38(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:62
case controllers_Players_update39(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:64
case controllers_Seasons_edit40(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:65
case controllers_Seasons_update41(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:67
case controllers_Games_edit42(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:68
case controllers_Games_update43(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:70
case controllers_Users_edit44(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:71
case controllers_Users_update45(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:74
case controllers_Matches_delete46(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:75
case controllers_Teams_delete47(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:76
case controllers_Referees_delete48(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:77
case controllers_Players_delete49(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:78
case controllers_Seasons_delete50(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:79
case controllers_Games_delete51(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:80
case controllers_Users_delete52(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:86
case controllers_Teams_upload54(params) => {
...
// @LINE:87
case controllers_Players_upload55(params) => {
   call(params.fromQuery[Long]("id", None)) { (id) =>
...
// @LINE:89
case controllers_Users_active56(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
